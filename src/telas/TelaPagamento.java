...
public class TelaPagamento extends javax.swing.JInternalFrame {
    ...
    private javax.swing.JPanel criarPainel(String[] labelTexts, int y) {
        ...
        // Convertendo as datas de entrada e saída de String para data
        LocalDate dataEntradaConvertida = LocalDate.parse(labelTexts[3]);
        LocalDate dataSaidaConvertida = LocalDate.parse(labelTexts[4]);
        ...
        float precoTotal = Float.parseFloat(labelTexts[5]) * qdtDias; // Calcula o preço total do quarto levando os dias em conta

        javax.swing.JLabel preco = new javax.swing.JLabel();
        preco.setText("R$ " + precoTotal);
    ...
    private void cancelarReserva() {
        ...
        try {
            ...
            int pagamento = JOptionPane.showConfirmDialog(null, "Cancelar Reserva?", "Atenção", JOptionPane.YES_NO_OPTION);
