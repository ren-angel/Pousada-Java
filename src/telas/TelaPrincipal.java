...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        usuarios.setText("Conta");
        usuarios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                usuariosActionPerformed(evt);
            }
        });
        menuGerenciar.add(usuarios);

        quartos.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A, java.awt.event.InputEvent.CTRL_DOWN_MASK));
    ...
    private void quartosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_quartosActionPerformed
        ...
        // Consulta se o campo admin do usuário atualmente logado é verdadeiro ou falso
        String sql = "SELECT admin FROM tbl_login WHERE id=?";
        ...
        try {
            ...
            if(rs.next()) {
                ...
                String admin = rs.getString("admin"); // Pega o valor do campo admin
                                
                // Se for admin, abre a tela de administrar quartos. Se não for admin, exibe a mensagem
                if (admin.equals("1")) {

                    fecharFrame(); // Chama o método fecharFrame ao abrir o frame

                    TelaAdmin quartos = new TelaAdmin(); // Criando uma instância da classe TelaAdmin

                    quartos.setVisible(true); // Torna visível o frame TelaAdmin

                    desktop.add(quartos); // Adiciona o frame TelaAdmin ao painel da área de trabalho
                } else {
                    
                    JOptionPane.showMessageDialog(null, "Você precisa de acesso admnistrador para entrar aqui");
                }
            }
        } catch (Exception e) {
