...
public class TelaReservar extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(scrollPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 500));
        ...
        getContentPane().add(btnVoltar, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 510, -1, -1));
    ...
    private void btnVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoltarActionPerformed
        ...
        this.dispose(); // Fecha a tela de reservar
